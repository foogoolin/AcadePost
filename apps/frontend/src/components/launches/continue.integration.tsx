    ...
    return (
      <div className="flex flex-1 items-center justify-center text-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-30">
          <div className="absolute top-[20%] left-[10%] w-[300px] h-[300px] bg-[#4cccb8] rounded-full blur-[120px]" />
          <div className="absolute bottom-[20%] right-[10%] w-[250px] h-[250px] bg-[#fda100] rounded-full blur-[120px]" />
        </div>
    ...
    <div className="flex flex-1 items-center justify-center text-white relative overflow-hidden">
      ...
      <div className="relative z-10 text-center">
        ...
        <div className="mt-[32px] flex justify-center">
          <div className="w-[48px] h-[48px] border-[3px] border-[#4cccb8] border-t-transparent rounded-full animate-spin" />
        </div>
      </div>
    </div>
  );
