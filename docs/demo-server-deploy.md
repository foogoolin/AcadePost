...
Le script cree `.env.demo` si absent, remplace les secrets demo par des valeurs aleatoires, valide le compose, tire l'image versionnee `ghcr.io/foogoolin/acadepost:v1.1.1` et lance la stack.
