  ...
  async approveOrDecline(email: string, action: string, id: string) {
    ...
    if (action === 'approve') {
      await this._notificationService.sendEmail(
        agency?.user?.email!,
        'Your agency has been approved and added to AcadéPost',
        `
<html lang="en">
...
<head>
    ...
    <title>Your agency has been approved and added to AcadéPost</title>
</head>

<body style="font-family: Arial, sans-serif; margin: 0; padding: 0;">
  Hi there, <br /><br />
  Your agency ${agency?.name} has been added to AcadéPost!<br />
  You can <a href="https://acadepost.com/agencies/${agency?.slug}">check it here</a><br />
...
<body style="font-family: Arial, sans-serif; margin: 0; padding: 0;">
  Hi there, <br /><br />
  Your agency ${agency?.name} has been declined for AcadéPost!<br />
    ...
    <table align="center" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%; background-color: #ffffff; margin-top: 20px; border: 1px solid #ddd;">
        ...
        <tr>
            <td style="padding: 20px; text-align: center; background-color: #000;">
                <a href="https://acadepost.com/agencies/action/approve/${
                  agency.id
                }" style="margin: 0 10px; text-decoration: none; color: #007bff;">To approve click here</a><br /><br /><br />
                <a href="https://acadepost.com/agencies/action/decline/${
                  agency.id
        ...
        <tr>
            <td style="padding: 20px; text-align: center; background-color: #f4f4f4;">
                <p style="color: #777; font-size: 14px;">&copy; 2026 AcadéPost. All rights reserved.</p>
            </td>
        </tr>
    </table>
</body>
